...
export declare function coerceIntoUint8(raw: ToUInt8): Result<Uint8Array>;
export declare function asyncCoerceIntoUint8(raw: AsyncToUInt8): Promise<Result<Uint8Array>>;
//# sourceMappingURL=coerce-uint8.d.ts.map
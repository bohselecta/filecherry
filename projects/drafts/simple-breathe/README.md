# simple-breathe - Static HTML Template
...
# Or rename it
mv index.html simple-breathe.html
```
...
# Minify the HTML
html-minifier --collapse-whitespace --remove-comments --minify-css --minify-js index.html -o simple-breathe.min.html
```
...
const db = fireproof('simple-breathe')
...
```bash
# Upload to CDN
aws s3 cp index.html s3://my-bucket/cherries/simple-breathe.html
